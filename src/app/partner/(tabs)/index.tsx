      ...
      >
        ...
        <View style={styles.bannerCard}>
          <View style={styles.bannerHeader}>
            ...
            <Text style={styles.bannerTitle}>Translate Employment Contract (ES→EN)</Text>
          </View>
          <Text style={styles.bannerSubtext}>
       Elena Rodriguez • Due Oct 22, 2026
          </Text>
        ...
        <TouchableOpacity style={styles.card} activeOpacity={0.7}>
          <View style={styles.cardHeader}>
            <Text style={styles.clientName}>Translate Employment Contract (ES→EN)</Text>
