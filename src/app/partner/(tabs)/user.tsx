...
export default function PartnerUserTab() {
  const router = useRouter();

  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.row} onPress={() => router.push('/partner/account-settings')}>
        <Text style={styles.label}>Account Settings</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.row} onPress={() => router.push('/partner/terms')}>
        <Text style={styles.label}>Terms & Conditions</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.row} onPress={() => router.push('/partner/privacy')}>
