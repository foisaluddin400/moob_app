...
const SLIDES = [
  {
    id: '1',
    title: 'Work that is clear and connected',
    subtitle:
      'Receive professional assignments with the files, deadlines and context you need.',
  ...
  },
  {
    ...
    subtitle:
      'Bring your expertise to a secure network of immigration professionals.',
...
export default function PartnerOnboardingScreen() {
  ...
  const handleFinish = () => {
    router.replace('/auth/partner/login' as any);
  };
