...
export default function ClientUserTab() {
      ...
      <View style={styles.groupCard}>
        ...
        >
          <View style={styles.iconContainer}>
            <Icon name="newImmi" size={18} color="#0f172a" />
          </View>
          <Text style={styles.rowLabel}>New Immigration Request</Text>
          <Feather name="chevron-right" size={18} color="#94a3b8" />
        </TouchableOpacity>

        <TouchableOpacity
          style={styles.menuRow}
          onPress={() => router.push("/partner/partnerMainChat")}
        >
          <View style={styles.iconContainer}>
        ...
        <TouchableOpacity
          style={styles.menuRow}
          onPress={() => router.push("/client/gdpr")}
        >
          <View style={styles.iconContainer}>
            <Icon name="gdpr" size={18} color="#0f172a" />
          </View>
          <Text style={styles.rowLabel}>GDPR Consent</Text>
          <Feather name="chevron-right" size={18} color="#94a3b8" />
        </TouchableOpacity>
      </View>
