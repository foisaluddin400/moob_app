...
export default function ClientUserTab() {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.row} onPress={() => router.push('/client/account-settings')}>
        <Text style={styles.label}>Account Settings</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.row} onPress={() => router.push('/client/terms')}>
        <Text style={styles.label}>Terms & Conditions</Text>
      </TouchableOpacity>
      <TouchableOpacity style={styles.row} onPress={() => router.push('/client/privacy')}>
