      ...
      >
        ...
        >
          ...
          <View style={styles.outgoingContainer}>
            ...
            <View style={styles.outgoingBubble}>
              <Text style={styles.outgoingText}>
                Welcome to the Sahara Desert Safari group chat! I am your guide, Ahmed.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.incomingContainer}>
            ...
            <View style={styles.incomingBubble}>
              <Text style={styles.incomingText}>
                Hello AI Assistant! Quick question, do we need to bring our own sleeping bags?
              </Text>
            </View>
          ...
          <View style={styles.outgoingContainer}>
            ...
            <View style={styles.outgoingBubble}>
              ...
              <Text style={styles.outgoingText}>
                No need! We provide all camping gear including warm sleeping bags. Just bring comfortable clothes and a jacket for the night.
              </Text>
            </View>
