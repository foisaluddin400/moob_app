...
const styles = StyleSheet.create({
  ...
  infoBannerTitle: { fontSize: 15, fontWeight: '400', color: '#00B2B7', fontFamily: 'Montserrat_400Regular' },
  infoBannerText: { fontSize: 12, color: '#00B2B7', lineHeight: 18, fontFamily: 'Montserrat_400Regular' },
  searchContainer: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  activeTabBtn: { backgroundColor: '#00B2B7', borderColor: '#00B2B7' },
  ...
  clientName: { fontSize: 16, fontWeight: '500', color: '#00B2B7', fontFamily: 'Montserrat_500Medium' },
  ...
  statusText: { fontSize: 11, color: '#00B2B7', fontWeight: '500', fontFamily: 'Montserrat_500Medium' },
